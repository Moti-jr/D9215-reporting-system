folders:
config -- contains the django app configurations 
d9215 -- contains the app architecture 
infrastructure -- contain the logic for gateway, load balancer, cache and auto scaler 
